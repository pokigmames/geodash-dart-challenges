            ...
            e.u = function (e) {
                ...
                e.e = function (n) {
                    return o(n).catch(function (o) {
                        var t = a.hasOwnProperty(n) ? a[n] : 3;
                        if (t < 1) {
                            var s = r(n);
    ...
    if (window === window.top || window.sdkLoaderWasInited) {
        ...
        window.isSdkLoader = !0,
            window.YaGames = {
                init: i => {
                    var d;
                    return t ? null == (d = window.YaGames) ? void 0 : d.init(i) : s ? Promise.reject(f) : n ? (console.warn("YaGames was initialized"),
                        n) : (n = new Promise((n, t) => {
                            e = n,
                                r = t,
                                o = i,
            ...
            , c = (e, r = {}) => {
                ...
                window.parent.postMessage({
                    ...
                    data: {
                        ...
                        additional: i(i(i({}, r), (null == (o = r.error) ? void 0 : o.message) ? {
        ...
        Object.defineProperty(window.YaGames, "deviceInfo", {
            get: () => (c("accessing deviceInfo in YaGames"),
                d)
        });
        const l = e => {
            ...
            , u = /(^|yandex\.net)\/sdk\/(v\d+|_)\/v2(\.[0-9a-f]*)?\.js/
            , w = "url sdk not valid"
            ...
            , g = (n, i) => {
                ...
                d.src = n,
                    d.onload = () => {
                        var n;
                        t = !0,
                            a && (null == (n = window.YaGames) || n.init(o).then(r => {
                                e(r)
                            }
                            ).catch(e => {
                                c("Error while init sdk", {
                                    error: e
                                }),
                                    r(e)
                            }
        ...
        h ? p(h) : (async () => new Promise((e, r) => {
            ...
            window.addEventListener("message", function r(a) {
                ...
                t && t.messageId === o && (window.removeEventListener("message", r),
                    clearTimeout(n),
                    e(t.payload))
            }),
